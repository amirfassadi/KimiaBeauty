const messages = {
  fa: {
    ...
    heroDescription: "به فضای کیمیا خوش آمدید. خدمات و اطلاعات تأییدشدهٔ سالن به‌زودی اینجا در دسترس خواهد بود.",
    ...
    contactTitle: "منتظر دیدار شما هستیم", contactDescription: "راه‌های ارتباطی تأییدشدهٔ سالن به‌زودی در این بخش قرار می‌گیرد.",
  ...
  en: {
    ...
    heroDescription: "Welcome to Kimia. Verified salon services and details will be available here soon.",
    ...
    contactTitle: "We look forward to meeting you", contactDescription: "Verified contact details will appear here soon.",
